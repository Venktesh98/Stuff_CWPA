...
from gzips import compress ,decompress
from main_crypto import Enc, Dec
file_path=None
...
# For copy......... Copy from Local directory to Copy Folder....................
    def pushButton_handler(self):
        ...
        # shutil.copy(Enc(compress(path)),'/media/akshar/D/Copy')
...
# For Paste....... Paste from Copy folder to Paste Folder...................................
    def pushButton_2_handler(self) :
        ...
        path = filename[0]
        file_path=path
        decompress(Dec(file_path))
        # shutil.copy(path,'F:\Paste')
